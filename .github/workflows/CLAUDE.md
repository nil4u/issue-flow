...
release-please.yml: GitHub main push/workflow_dispatch 入口，维护 plugin 与 console 两个包的 release PR、CHANGELOG、tag 与 GitHub Release；console release 创建后同步构建并推送 GHCR 镜像。
