...
function optimizationStateLabel(state) {
  return ({ feedback: "开发者反馈", pending: "待处理", ignored: "已忽略", created: "已创建", executing: "执行中", completed: "已完成", cancelled: "已取消" })[state] || "待处理"
}
